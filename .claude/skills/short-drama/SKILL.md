...
所有创作产物保存在项目的 `2-剧本/` 目录下（对应流水线第二阶段）：
...
5. 汇总确认后，保存状态到 `2-剧本/.drama-state.json`，提示进入下一步 `/plan`
...
**输出：** 保存为 `2-剧本/导出/{剧名}-完整剧本.md`

**结束提示：**
```
✅ 剧本已导出！

📁 文件位置：2-剧本/导出/{剧名}-完整剧本.md
📊 已完成：{N}/{总数}集
📝 总字数：{统计}
